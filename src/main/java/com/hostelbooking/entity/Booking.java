...
public class Booking {
	...
	public String getProgramName() {
		return guest != null ? guest.getProgramName() : null;
	}

	public Long getProgramId() {
		return guest != null && guest.getProgram() != null ? guest.getProgram().getId() : null;
	}
	...
	public Booking(Long id, Guest guest, Room room, LocalDate checkInDate, LocalDateTime checkInTime,
			LocalDate checkOutDate, LocalDateTime checkOutTime, GuestStatus status, User checkInUser,
			User checkOutUser) {
		super();
		this.id = id;
		this.guest = guest;
	...
	public String toString() {
		return "Booking [id=" + id + ", guest=" + guest + ", room=" + room + ", checkInDate=" + checkInDate
				+ ", checkInTime=" + checkInTime + ", checkOutDate=" + checkOutDate + ", checkOutTime=" + checkOutTime
				+ ", status=" + status + ",  checkInUser=" + checkInUser + ", checkOutUser=" + checkOutUser + "]";
	}
